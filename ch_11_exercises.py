...
Single_family_home = vehicles.SingleFamilyHome('6', '1200', '1', '1', '.25')
# 8) Display the data using the accessor methods
print('Number of rooms:', Single_family_home.get_number_of_rooms())
print('Square feet:', Single_family_home.get_square_feet())
print('Floors:', Single_family_home.get_floors())
print('Garage type:', Single_family_home.get_garage_type())
print('Yard size:', Single_family_home.get_nuyard_size())
