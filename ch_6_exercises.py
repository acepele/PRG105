...
state_capitals.write("New York, Albany\n")
...
for counter in range(1, books + 1):
    print("Enter the title and the author of your book" + str(counter))
...
input_file = open('superheros.txt', 'r')
# 3) Close the file
input_file.close()
